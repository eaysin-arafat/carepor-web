...
const NameSearch = ({
  ...
  return (
    <div className="w-full">
      <div className="md:custom-input !rounded-full md:items-center md:py-0 md:mt-[6px] md:h-[44px] md:grid md:grid-cols-4 md:me-5 md:borderColor md:dark:border-[#6B7280] md:focus:border-gray-300 space-y-3 md:space-y-0 ">
